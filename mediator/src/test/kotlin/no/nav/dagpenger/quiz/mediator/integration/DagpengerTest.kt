...
import no.nav.dagpenger.quiz.mediator.soknad.dagpenger.BarnetilleggRegister
...
internal class DagpengerTest : SøknadBesvarer() {
    ...
    fun `Skal få seksjonene i riktig rekkefølge, mao slik som designerne har kommet fram til`() {
        withSøknadsId { besvar ->
            ...
            søknadsprosess.verifiserAtNesteSeksjonEr(BarnetilleggRegister)
            besvar(BarnetilleggRegister.`barn liste register`, 0)

            søknadsprosess.verifiserAtNesteSeksjonEr(BarnetilleggSøker)
