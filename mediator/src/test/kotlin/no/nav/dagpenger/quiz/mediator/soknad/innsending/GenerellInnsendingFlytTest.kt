...
class GenerellInnsendingFlytTest {
    ...
    fun `Innsending flyt - letteste vei til ferdig`() {
        prosess
            .envalg(GenerellInnsending.`hvorfor sender du inn dokumentasjon`)
            .besvar(Envalg("faktum.generell-innsending.hvorfor.svar.endring"))
        prosess
            .tekst(GenerellInnsending.`tittel på dokument`)
    ...
    fun `Innsending flyt - svar vet-ikke`() {
        ...
        prosess
            .tekst(GenerellInnsending.`skriv kort hvorfor du sender inn dokumentasjon`)
            .besvar(Tekst("Derfor"))
        prosess
            .tekst(GenerellInnsending.`tittel på dokument`)
            .besvar(Tekst("En vakker historie om hva jeg vil"))
