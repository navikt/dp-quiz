...
object Barnetillegg : DslFaktaseksjon {
    ...
    override fun regeltre(fakta: Fakta): DeltreSubsumsjon =
        with(fakta) {
            "barnetillegg".deltre {
                "barnetillegg fra PDL register"
                    .minstEnAv(
                        generator(`barn liste register`) minst 0,
                        generator(`barn liste register`) minst 1 hvisOppfylt {
                            generator(`barn liste register`) med
                                "et eller flere barn".deltre {
    ...
    private fun Fakta.`barnets navn, fødselsdato og bostedsland`() =
        "navn, dato og bostedsland".alle(
    ...
    private val navSpørsmålsrekkefølge =
        listOf(
            `barn liste register`,
