...
internal class ProsessMetadataStrategi : MetadataStrategi {
    override fun metadata(prosess: Prosess): Metadata = SkjemastrategiVelger(prosess).skjemakodeStrategi()

    private class SkjemastrategiVelger(
