...
object AndreYtelser : DslFaktaseksjon {
    ...
    const val `dokumentasjon arbeidsløs GFF periode` = 5017
    const val `dokumentasjon garantilott fra GFF periode` = 5018
    const val `dokumentasjon etterlønn` = 5019
    const val `dokumentasjon dagpenger eøs land` = 5020
    const val `dokumentasjon annen ytelse` = 5021
    const val `dokumentasjon økonomiske goder fra tidligere arbeidsgiver` = 5022
    const val `godkjenning dokumentasjon andre ytelser` = 5023
    ...
    override var fakta = listOf(
        ...
        boolsk faktum "faktum.godkjenning-dokumentasjon-andre-ytelser" id `godkjenning dokumentasjon andre ytelser`
            avhengerAv `dokumentasjon tjenestepensjon`
            og `dokumentasjon garantilott fra GFF periode`
            og `dokumentasjon arbeidsløs GFF periode`
            og `dokumentasjon etterlønn`
            og `dokumentasjon dagpenger eøs land`
            og `dokumentasjon annen ytelse`
            og `dokumentasjon økonomiske goder fra tidligere arbeidsgiver`
    )

    override fun seksjon(søknad: Søknad) = listOf(søknad.seksjon("andre-ytelser", Rolle.søker, *spørsmålsrekkefølgeForSøker()), søknad.seksjon("godkjenningAndreYtelser", Rolle.saksbehandler, *spørsmålsrekkefølgeForSaksbehandler))
            ...
            "Har eller har ikke andre ytelser".minstEnAv(
                ...
                "Felles avsluttningsspørsmål".minstEnAv(
                    ...
                    (boolsk(`utbetaling eller økonomisk gode tidligere arbeidsgiver`) er true)
                        ...
                        .godkjentAv(boolsk(`godkjenning dokumentasjon andre ytelser`)) hvisOppfylt {
    ...
    val spørsmålsrekkefølgeForSaksbehandler = listOf(
        `godkjenning dokumentasjon andre ytelser`
    ).toIntArray()
}
