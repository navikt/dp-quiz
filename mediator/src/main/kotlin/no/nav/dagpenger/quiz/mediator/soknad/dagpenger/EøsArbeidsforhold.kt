...
object EøsArbeidsforhold : DslFaktaseksjon {
    ...
    private fun Fakta.`eøs arbeidsforhold`() =
        "Arbeidsforhold i EØS området".minstEnAv(
            ...
            boolsk(`eøs arbeid siste 36 mnd`) er true hvisOppfylt {
                "Hvis ja, må det oppgi arbeidsforhold".alle(
                    ...
                    generator(`eøs arbeidsforhold`) har
                        "En til flere EØS arbeidsforhold".deltre {
    ...
    private fun Fakta.`er gjenopptak`() = envalg(DinSituasjon.`mottatt dagpenger siste 12 mnd`) inneholder Envalg("faktum.mottatt-dagpenger-siste-12-mnd.svar.ja")

    private fun Fakta.`har jobbet siden sist eller hatt endringer i arbeidsforhold`() = boolsk(DinSituasjon.`gjenopptak jobbet siden sist du fikk dagpenger eller hatt endringer i arbeidsforhold`) er true
    ...
    override fun seksjon(fakta: Fakta) = listOf(fakta.seksjon("eos-arbeidsforhold", Rolle.søker, *spørsmålsrekkefølgeForSøker()))
