...
open class FaktumNavn<R> private constructor(private val rootId: Int, val navn: String, private val indeks: Int) {
    ...
    fun indeks(indeks: Int) = FaktumNavn<R>(this.rootId, "$navn [$indeks]", indeks).also {
