...
internal class NyttEksempel {
    ...
    private val datosjekk =
        "datosjekk".alle(
            p1Boolean er true,
            p2Dato etter p_3_4_5Dato,
            p3Dato før p4Dato,
        )
    private val dokumentOpplastning =
        "dokumentopplastning" deltre {
            p10Boolean er true hvisIkkeOppfylt { p12Boolean dokumenteresAv p11Dokument }
        }
    private val inntektValidering =
        "inntektvalidering".minstEnAv(
            p6Inntekt minst p8Inntekt,
            p7Inntekt minst p9Inntekt,
        )
    private val alderSjekk =
        "aldersjekk" deltre {
